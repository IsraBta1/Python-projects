...
def test_cels_from_fahr():
    """Test the cels_from_fahr function by calling it and comparing the value ir returns to the expected value.
...
# Call the main function that si part of pytest so that the computer will execute the test function in this file.
