...
Chemistry Activity
Dictionary of element symbols and their corresponding names and atomic masses.
"""

def make_periodic_table():
    """Return the periodic table as a dictionary.

    The keys are element symbols and the values are lists with the
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    """Return the molar mass for the given compound list."""
    molar_mass = 0.0
